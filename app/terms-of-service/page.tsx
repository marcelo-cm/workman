        ...
        <div className="container mx-auto">
          ...
          <div className="rounded-md bg-white p-6 shadow-sm">
            <div className="space-y-6">
              ...
              <h2 className="text-xl font-medium">1. SCOPE OF SERVICE AND RESTRICTIONS</h2>
              
              <h3 className="text-lg font-medium">1.1 Access to and Scope of Service</h3>
              <p className="text-gray-700">
              ...
              <h3 className="text-lg font-medium">1.9 Support and Uptime SLA</h3>
              <p className="text-gray-700">
              ...
              <h3 className="text-lg font-medium">5.1 Indemnification by Customer</h3>
              <p className="text-gray-700">
              ...
              <h3 className="text-lg font-medium">5.2 Indemnification by Workman</h3>
              <p className="text-gray-700">
              ...
              <h3 className="text-lg font-medium">5.3 Notice of Claim and Indemnity Procedure</h3>
              <p className="text-gray-700">
              ...
              <h3 className="text-lg font-medium">6.3 Disclaimer of Warranty</h3>
              <p className="text-gray-700">
              ...
              <h2 className="text-xl font-medium">7. LIMITATIONS OF LIABILITY</h2>
              <p className="text-gray-700">
