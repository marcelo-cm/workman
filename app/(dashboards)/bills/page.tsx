...
import { InvoiceDataTable } from '@/components/(dashboards)/data tables/data-table-invoice';
import ExtractionReview from '@/components/(dashboards)/extraction/ExtractionReview';
