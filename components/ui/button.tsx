...
const buttonVariants = cva(
  "dark inline-flex flex-row gap-2 items-center font-instrument-sans transition-all duration-300 justify-center rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
        ...
        outline: "border text-wm-white-950 hover:opacity-60",
        ghost: "text-wm-white-950 hover:opacity-60",
      },
      size: {
